...
cat(paste("\nestimate_errors.R started at ", Sys.time()), file = progress_file, append = TRUE)
...
# plot error rates ####
pdf(paste(plot_path, 'error_rates.pdf', sep = '/'))
...
cat(paste("\nestimate_errors.R ended at ", Sys.time()), file = progress_file, append = TRUE)
